...
branch, that you can then use with the service of your choice to deploy your
...
1. Go to your Github repository settings. 2. Click on "Pages" in the left
sidebar. 3. Under "Build and deployment", select:
   - Deploy from branch
