...
To cite package ‘altdoc’ in publications use:
  ...
  Bacher E (????). _altdoc: Package Documentation Websites with 'Quarto', 'Docsify',
  'Docute', or 'MkDocs'_. R package version 0.2.2.9011,
  https://github.com/etiennebacher/altdoc, <https://altdoc.etiennebacher.com>.
